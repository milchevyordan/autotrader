        ...
        <tr>
            ...
            <td class="width-70 align-top">
                <div class="align-vertical">
                    <div class="heading font-28">{{ __('INVOICE') }}</div>
                    <div class="text-s pt-2">{{ __('Invoice number') }}: {{ $document->number }}</div>
                    <div class="text-s">{{ __('Debtor number') }}: {{ $document->customerCompany?->debtor_number_accounting_system }}</div>
