        ...
        <tr>
            ...
            <td class="width-70 align-top">
                <div class="align-vertical">
                    <div class="heading font-28">{{ __('CREDIT INVOICE') }}</div>
                    <div class="text-s pt-2">{{ __('Debtor number') }}: {{ $document->customerCompany?->debtor_number_accounting_system }}</div>
                    <div class="text-s">{{ __('Invoice number') }}: {{ $document->number }}</div>
...
<div class="container text-s break-inside-avoid">
    @include('components.customer-company', [
        'topText' => __('Credit invoice issued to'),
...
<div class="container text-s">
                ...
                <div class="py-1 border-bottom align-top break-inside-avoid">
                    ...
                    <table class="w-full">
                        <tr>
                            ...
                            @include('components.documents.vat-percentage-and-price', ['creditInvoice' => true])
                        </tr>
                    </table>
                </div>
            @endforeach
    ...
    <table class="w-full fw-bold font-9 pt-1 break-inside-avoid">
        <tr>
            ...
            <td class="width-12and5 no-wrap align-top py-half"><span class="p-quarter">{{ \App\Support\CurrencyHelper::showMinusIfEmpty($document->total_price_exclude_vat) }} -/-</span>
            </td>
        </tr>
        <tr>
            <td class="width-75 py-half"></td>
        ...
        <tr>
            ...
            <td class="width-12and5 no-wrap align-top py-half"><span class="p-quarter">{{ \App\Support\CurrencyHelper::showMinusIfEmpty($document->total_vat) }} -/-</span>
            </td>
        </tr>
        <tr>
            <td class="width-75 py-half"></td>
            <td class="width-12and5 align-top py-half"><span class="p-quarter">{{ __('Total payable') }}</span></td>
            <td class="width-12and5 no-wrap align-top py-half"><span class="p-quarter">{{ \App\Support\CurrencyHelper::showMinusIfEmpty($document->total_price_include_vat) }} -/-</span>
            </td>
        </tr>
    </table>
    <div class="font-9">
...
<div class="container font-9">
    <div>{{ __('This credit invoice refers to our invoice with number ') }} {{ $document->number }}</div>
    <div class="pt-1">{{ __('The amount will be credited to your bank account within one week') }}</div>
</div>
