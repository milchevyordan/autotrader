...
class StoreCompanyRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'email'                => ['nullable', 'string', 'email', 'max:'.config('app.validation.rules.maxStringLength'), 'unique:companies'],
            'phone'                => ['required', 'string', 'max:25'],
            'iban'                 => ['nullable', 'string', 'min:15', 'max:34', 'unique:companies'],
            'swift_or_bic'         => ['nullable', 'string', 'min:8', 'max:11'],
            'bank_name'            => ['nullable', 'string', 'min:2'],
            'kvk_number'           => ['nullable', 'digits_between:8,255', 'unique:companies'],
