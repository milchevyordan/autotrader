...
class UpdatePurchaseOrderRequest extends StorePurchaseOrderRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'total_transport'                  => ['nullable', 'string'],
            ...
            'papers'                           => ['nullable', Rule::in(Papers::values())],
            'payment_condition'                => ['nullable', Rule::in(PaymentCondition::values())],
            'payment_condition_free_text'      => ['nullable', 'string'],
            'sales_restriction'                => ['nullable', 'string'],
            'contact_notes'                    => ['nullable', 'string'],
            'vehicleIds'                       => ['array'],
            'internal_remark_user_ids'         => ['nullable', 'required_with:internal_remark_present', 'array'],
            'internal_remark_role_ids'         => ['nullable', 'required_with:internal_remark_present', 'array'],
            'internal_remark'                  => ['nullable', 'required_with:send_to_present', 'string'],
            'files.*'                          => [
                new FileOrFileable(),
            ],
            'contractSignedFiles.*' => [
