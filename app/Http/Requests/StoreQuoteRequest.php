...
class StoreQuoteRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'type'                                   => ['nullable', Rule::in(ImportOrOriginType::values())],
            'seller_id'                              => ['nullable', 'integer'],
            'name'                                   => ['nullable', 'string', 'max:'.config('app.validation.rules.maxStringLength')],
            'service_level_id'                       => ['nullable', 'integer'],
            'delivery_week'                          => ['nullable', 'array', new ValidWeek()],
            ...
            'total_quote_price_exclude_vat'          => ['nullable', 'string'],
            'total_registration_fees'                => ['nullable', 'string'],
            'total_quote_price'                      => ['nullable', 'string'],
            'is_brutto'                              => ['required', 'boolean'],
            'calculation_on_quote'                   => ['required', 'boolean'],
            'items'                                  => ['array'],
