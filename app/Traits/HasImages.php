...
trait HasImages
{
    public ?Collection $uploadedImages = null;
     ...
     * @return array an array where each key represents a section, and the corresponding
    ...
    /**
     * Update the profile image (image_path) to be the first image of the section provided in model's profileImageSection variable.
     *
     * @return void
     */
    ...
    /**
     * Get the value of uploadedImages.
     *
     * @return ?Collection
     */
