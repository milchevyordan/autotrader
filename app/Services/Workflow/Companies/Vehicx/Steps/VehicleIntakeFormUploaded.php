...
class VehicleIntakeFormUploaded extends Step implements StepWithFilesInterface, StepWithRedFlagInterface
{
    public const NAME = 'Vehicle Intake form Uploaded';
    ...
    public function getRedFlag(): RedFlag
    {
        ...
        return new RedFlag(
            ...
            isTriggered: $vehicleReceived->transportOrderDeliveredDateCarbonObject?->isBefore(Carbon::yesterday()) && ! $this->isCompleted()
        );
    }
}
