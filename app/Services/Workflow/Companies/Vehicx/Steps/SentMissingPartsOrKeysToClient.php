...
class SentMissingPartsOrKeysToClient extends Step implements StepWithDateInputInterface, StepWithRedFlagInterface
{
    public const NAME = 'Sent Missing Parts Or Keys To Client';
    ...
    {
        return new RedFlag(
            name: 'Sent Missing Parts Or Keys To Client',
            description: 'Missing parts or keys are not sent to client yet',
