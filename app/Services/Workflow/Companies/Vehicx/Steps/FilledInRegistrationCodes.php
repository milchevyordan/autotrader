...
class FilledInRegistrationCodes extends Step implements StepWithDateInputInterface, StepWithRedFlagInterface
{
    public const NAME = 'Filled in Registration Codes';
