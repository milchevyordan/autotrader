...
class FinalisedReclamationWithSupplier extends Step implements StepWithDateInputInterface, StepWithRedFlagInterface
{
    public const NAME = 'Finalised Reclamation With Supplier';
    ...
    {
        return new RedFlag(
            name: 'Finalised Reclamation With Supplier',
            description: 'Reclamation with supplier is still open',
