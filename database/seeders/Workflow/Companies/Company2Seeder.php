...
class Company2Seeder extends Base
{
    /**
     * Company's place when seeding this was second so id 2.
     *
     * @var int
     */
            ...
            'statuses' => [
                [
                    ...
                    'steps' => [
                        [
                            'name'                       => 'Receive VIN',
                            'variable_map_name'          => 'hasVinNumber',
                            'additional_modal_component' => null,
                        ],

                        [
                            'name'                       => 'Receive first registration date',
                            'variable_map_name'          => 'hasFirstRegistrationDate',
                            'additional_modal_component' => null,
                        ],
                    ],
                ],
    ...
    /**
     * Create a new Company2Seeder instance.
     */
